...
public class GeneratorDescriptor extends ShaftDescriptor {
    ...
    final ThermalLoadInitializer thermalLoadInitializer;
    public IFunction RtoU;

    public GeneratorDescriptor(String name, Class ElementClass, Class RenderClass, ElectricalCableDescriptor cable, Obj3D obj, float nominalRads, float nominalU, float powerOutPerDeltaU, float nominalP, ThermalLoadInitializer thermalLoadInitializer) {
